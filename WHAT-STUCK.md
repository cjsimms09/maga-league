...
| three outside WEEKLY projection sources as a challenger (P365, registers 478/480) | ESPN, FleaFlicker and NumberFire publish real weekly numbers (CBS answers a weekly request with its season totals, so it is dropped by name — caught the same night). Built 09-02: captured every Wednesday, averaged under our scoring, graded beside our champion on the same players; it can never promote itself | first graded week 09-15; verdict on weeks 1-4 by 10-13 |
