...
exports.runCapture = async () => {
  try {
    ...
    if (mark) {
      console.log(`[waiver-reco] marker ${markKey} was written ${mark.at}, before week ${ctx.week}'s capture window opened — recapturing at the real decision moment (register 434)`);
    }
