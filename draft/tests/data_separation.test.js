...
const PRODUCTION_INPUTS = {
  ...
  'nfl_schedule_2026.json': 'THE 2026 NFL SCHEDULE (week -> first/last kickoff), '
    + 'captured by .github/workflows/bdl-schedule-capture.yml from Ball Don\'t '
    + 'Lie\'s free tier. Read by src/capture_window.js (A, 2026-08-31, register '
    + '434) for ONE question and nothing else: is week N\'s decision moment '
    + 'actually near? It carries NO projection, rank, score or dollar — the '
    + 'only values read are two timestamps per week — so it cannot reach a '
    + 'recommendation\'s content, only its TIMING. Why it must: Sleeper flips '
    + 'to regular/week-1 up to eleven days before that week\'s first game, and '
    + 'the reco captures are one-per-week-ever, so a fire in that gap records '
    + 'advice nobody could have made yet and then suppresses the real one. '
    + 'Measured, not theorised: lineup_auto|2026|w1|1 was written 2026-08-30 '
    + 'against a first game of 2026-09-10. DEGRADES HONESTLY and that is '
    + 'load-bearing — weekIsLive() returns null when the schedule cannot '
    + 'answer, null does not block, so a missing file restores the previous '
    + 'behaviour instead of becoming a silent season-long refusal to capture.',
