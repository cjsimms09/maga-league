...
# Ratchet tightened 2026-09-02 as the test itself prescribed when the gap
# closed 8 -> 6 on the board (relay, GO sweep): 7066 resolved, so it leaves
# the known-unresolvable set.
