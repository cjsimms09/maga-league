...
_board `2026-08-25T21:01:04Z` · slot **8** (site-claimed — Sleeper draft order pending (regenerates on assignment)) · doctrine: **Balanced Value (the control)** (19b race ran; no archetype cleared the paired CI + even-money band)_
...
### Pick 33
- **TARGET**: Drake Maye (QB, VORP 23.5, 31% survives)
- fallback 1: Tyler Warren (TE, VORP 19.8, 28% survives)
- fallback 2: Joe Burrow (QB, VORP 16.9, 35% survives)
- fallback 3: Bhayshul Tuten (RB, VORP 12.0, 62% survives)
- fallback 4: Jalen Hurts (QB, VORP 11.6, 71% survives)

### Pick 48
- **TARGET**: Kyle Pitts (TE, VORP 10.0, 65% survives)
- fallback 1: Sam LaPorta (TE, VORP 9.6, 49% survives)
- fallback 2: Harold Fannin (TE, VORP 9.2, 35% survives)
- fallback 3: Dak Prescott (QB, VORP 8.7, 82% survives)
- fallback 4: Tucker Kraft (TE, VORP 4.4, 35% survives)

### Pick 53
- **TARGET**: Kyle Pitts (TE, VORP 10.0, 44% survives)
- fallback 1: Sam LaPorta (TE, VORP 9.6, 42% survives)
- fallback 2: Dak Prescott (QB, VORP 8.7, 57% survives)
- fallback 3: Brock Purdy (QB, VORP 3.3, 100% survives)
- fallback 4: Travis Kelce (TE, VORP 2.2, 84% survives)
