...
- blend 0.406 · naive 0.35 · market/ADP 0.239 (n=38 picks)
- **naive − blend: -0.056 CI [-0.114, -0.002] → negative**
- naive − market: 0.111 CI [-0.013, 0.225] → inconclusive
- blend − market: 0.167 CI [0.083, 0.253] → positive
