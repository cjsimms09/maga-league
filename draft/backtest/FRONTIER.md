...
_control λ=0: weekly mean 102.0, sd 32.3 · 150 paired rooms · **H1 (optimum toward the high-variance corner): SUPPORTED**_

| candidate | edge $ | 95% CI | weekly mean | weekly sd | verdict |
|---|---|---|---|---|---|
| flat_l0.25 | +487.83 | [433.33, 540.83] | 124.5 | 37.9 | WINNER — install via the gates (slider change, cited) |
| late_l1.0 | +387.33 | [327.17, 442.0] | 121.7 | 38.2 | WINNER — install via the gates (slider change, cited) |
