...
_my keepers + my picks (34, 41, 54…) on the PREDICTED board · 200 paired rooms · control: Balanced · **ENROLLED: LATE_QB**_

| archetype | mean edge $ | 95% CI | decisions ≠ control | verdict |
|---|---|---|---|---|
| late_qb | +31.00 | [6.88, 56.75] | 4.9 | WINNER — enroll as THE PLAN |
| robust_rb | +0.00 | [0.0, 0.0] | 0.0 | parked: CI includes $0 |
| early_qb | +0.00 | [0.0, 0.0] | 0.0 | parked: CI includes $0 |
| wr_anchor | -10.12 | [-27.62, 7.38] | 1.6 | parked: CI includes $0 |
| zero_rb | -18.50 | [-40.75, 2.38] | 1.4 | parked: CI includes $0 |
| hero_rb | -18.50 | [-41.75, 2.5] | 1.4 | parked: CI includes $0 |
| elite_te | -24.62 | [-46.88, -4.88] | 3.0 | LOSER — significantly worse than the control |
