...
_conditional null p95 = **$50.21** (the null mines the SAME policy×state grid over permuted state labels — 40 draws). State coverage: run_pressure=0 rooms, rb_drain_early=58 rooms, thin_board_early=59 rooms_
