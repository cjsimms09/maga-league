<!-- TERRITORY: E -->
# PREREGISTRATION — the tier-ramped mean→ceiling blend (register 60/62, P133)
...
**P133-a (points/dollars, the E1-E5 estimand).** `mean(T1 − T0)` on the
...
**P133-b (the mechanism — where I expect it to actually move something).**
...
mechanism itself has failed regardless of what P133-a says, and that is the
more informative failure to report.

**P133-c (does it interact with the un-fieldable-lineup problem, register
