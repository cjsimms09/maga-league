...
**Mask's own value** (vs no-mask VORP-greedy): -767.1 CI[-806.58, -727.58] — negative here would mean the mask helps.
...
| 0.5 | +3.1 | [-3.0, 9.33] | ≈0 / underpowered |
| 1.0 | +11.7 | [3.25, 20.92] | separable from 0 |
| 1.5 | +7.4 | [-9.0, 23.25] | ≈0 / underpowered |
| 2.0 | +6.8 | [-9.67, 22.67] | ≈0 / underpowered |
| 3.0 | +6.8 | [-9.67, 22.67] | ≈0 / underpowered |

## Schedules (edge vs mask)

| schedule | edge $ | 95% CI |
|---|---|---|
| auto_ramp | +4.2 | [-10.08, 18.0] |
| early_heavy | +10.7 | [2.33, 19.67] |
| late_heavy | +6.8 | [-9.67, 22.67] |
...
**Ramp:** ramping does NOT beat a flat weight (a small flat w≈0.5 wins); the phase schedule of the need-weight adds nothing (ramp − best flat = -7.5).
