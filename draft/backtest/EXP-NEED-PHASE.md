...
**Mask's own value** (vs no-mask VORP-greedy): -631.4 CI[-675.67, -589.25] — negative here would mean the mask helps.
...
| 0.5 | -5.0 | [-12.75, 1.67] | ≈0 / underpowered |
| 1.0 | -1.1 | [-9.83, 8.25] | ≈0 / underpowered |
| 1.5 | -1.1 | [-9.83, 8.25] | ≈0 / underpowered |
| 2.0 | -1.1 | [-9.83, 8.25] | ≈0 / underpowered |
| 3.0 | -1.1 | [-9.83, 8.25] | ≈0 / underpowered |

## Schedules (edge vs mask)

| schedule | edge $ | 95% CI |
|---|---|---|
| auto_ramp | -1.1 | [-9.83, 8.25] |
| early_heavy | -1.1 | [-9.83, 8.25] |
| late_heavy | -1.1 | [-9.83, 8.25] |
...
**Ramp:** ramping does NOT beat a flat weight (a small flat w≈0.5 wins); the phase schedule of the need-weight adds nothing (ramp − best flat = -1.1).
