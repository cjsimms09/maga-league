...
**Mask's own value** (vs no-mask VORP-greedy): -5.7 CI[-15.92, 4.58] — negative here would mean the mask helps.
...
| 0.5 | +0.0 | [0.0, 0.0] | ≈0 / underpowered |
| 1.0 | +0.0 | [0.0, 0.0] | ≈0 / underpowered |
| 1.5 | +0.0 | [0.0, 0.0] | ≈0 / underpowered |
| 2.0 | +0.0 | [0.0, 0.0] | ≈0 / underpowered |
| 3.0 | +0.0 | [0.0, 0.0] | ≈0 / underpowered |

## Schedules (edge vs mask)

| schedule | edge $ | 95% CI |
|---|---|---|
| auto_ramp | +0.0 | [0.0, 0.0] |
| early_heavy | +0.0 | [0.0, 0.0] |
| late_heavy | +0.0 | [0.0, 0.0] |
