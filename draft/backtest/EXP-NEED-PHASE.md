...
**Mask's own value** (vs no-mask VORP-greedy): -560.2 CI[-605.25, -520.67] — negative here would mean the mask helps.
...
| 0.5 | +5.6 | [-3.42, 15.42] | ≈0 / underpowered |
| 1.0 | +5.9 | [-2.83, 15.67] | ≈0 / underpowered |
| 1.5 | +5.9 | [-2.83, 15.67] | ≈0 / underpowered |
| 2.0 | +5.9 | [-2.83, 15.67] | ≈0 / underpowered |
| 3.0 | +5.9 | [-2.83, 15.67] | ≈0 / underpowered |

## Schedules (edge vs mask)

| schedule | edge $ | 95% CI |
|---|---|---|
| auto_ramp | +5.9 | [-2.83, 15.67] |
| early_heavy | +5.9 | [-2.83, 15.67] |
| late_heavy | +5.9 | [-2.83, 15.67] |
...
**Ramp:** ramping does NOT beat a flat weight (a small flat w≈0.5 wins); the phase schedule of the need-weight adds nothing (ramp − best flat = +0.0).
