...
**Mask's own value** (vs no-mask VORP-greedy): -563.2 CI[-606.42, -522.33] — negative here would mean the mask helps.
...
| 0.5 | -5.8 | [-17.17, 4.58] | ≈0 / underpowered |
| 1.0 | -1.9 | [-14.33, 9.58] | ≈0 / underpowered |
| 1.5 | -1.9 | [-14.33, 9.58] | ≈0 / underpowered |
| 2.0 | -1.9 | [-14.33, 9.58] | ≈0 / underpowered |
| 3.0 | -1.9 | [-14.33, 9.58] | ≈0 / underpowered |

## Schedules (edge vs mask)

| schedule | edge $ | 95% CI |
|---|---|---|
| auto_ramp | -1.9 | [-14.33, 9.58] |
| early_heavy | -1.9 | [-14.33, 9.58] |
| late_heavy | -1.9 | [-14.33, 9.58] |
...
**Ramp:** ramping does NOT beat a flat weight (a small flat w≈0.5 wins); the phase schedule of the need-weight adds nothing (ramp − best flat = -1.9).
