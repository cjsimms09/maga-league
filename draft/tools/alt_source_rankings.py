...
def main() -> None:
    ...
    # indent=1 matches this artifact's own on-disk format exactly (verified
    # byte-for-byte against a re-serialize-with-no-changes round trip) — a
    # compact re-write here would turn a real, additive diff into a 64,000-line
    # noise diff that hides the actual change.
