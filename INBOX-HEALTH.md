...
_Last measured: 2026-08-18 13:40 UTC_

```
============================================================================
ROUTES RESPONSE CHECK — is anyone answering?
============================================================================
  435 items · 243 open · 107 of those carry a DEFAULT (silence resolves them)
  41 BLOCKED — open, no default, 3+ days old. Silence answers nothing here.
  of 136 open item(s) with no default: 4 SAY they ask for nothing · 9 are BROADCASTS (same
  header in 3+ inboxes — a rule, not four decisions) · 123 declare NEITHER, so nobody
  ...
  (a low rate is a QUESTION: real backlog, or answered and never ticked?)
    ...
    A → C                     12 items    42% ticked    0 open with NO default
  ...
  ✅ DOWN 24. Lower the baseline to 41 in draft/baseline/routes_backlog_baseline.json to lock the gain in —
...
============================================================================
  ...
  ⚠️    3 commits    22h old  claude/in-season-surface-fixes-6nyayc
        ...
        1 commits    39h old  sleeper-vs-fp-grade-dispatch
