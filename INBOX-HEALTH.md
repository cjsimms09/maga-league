...
_Last measured: 2026-09-17 17:37 UTC_
...
============================================================================
  ...
  the five oldest:
    5d  2026-09-12 · relay → A/C · 🔴 **DAILY GO SWEEP: 5 RED — draft-data.yml (509's drift continues + 
    4d  2026-09-13 · relay → A/C · 🔴 **DAILY GO SWEEP: SAME 6 RED CAPTURES AS 09-12, DRAFT-DATA.YML WOR
    3d  2026-09-14 · relay → A/C · 🔴 **DAILY GO SWEEP: SAME 5 RED CAPTURES, ALL ALREADY-TRACKED — DRAFT
  ...
  (a low rate is a QUESTION: real backlog, or answered and never ticked?)
    ...
    relay → E                 21 items    24% ticked    0 open with NO default
    ...
    A → B                     75 items    97% ticked    0 open with NO default
...
============================================================================
        1 commits    52h old  claude/focused-carson-yexs5a
        1 commits    99h old  claude/happy-faraday-ng1q2t
