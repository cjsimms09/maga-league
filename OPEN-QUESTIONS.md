...
| Q11 | **What are Cory's actual E3/E4 rates today?** Title rate and playoff rate over his real seasons — the baseline every claim of edge is measured against. | You cannot beat a number nobody has computed. `champodds` and the replay harness exist; nothing joins them to his real finishes. | S | **E** |
