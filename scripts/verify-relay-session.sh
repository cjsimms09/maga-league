...
echo "('⚡ THE QUEUE'). ONE call open before the 22nd: promote own_v6 (clears"
echo "REC-3 at all four positions; prepared diff in the program doc, NOT"
echo "applied — recommendation YES). Six are RULED AND EXECUTED"
