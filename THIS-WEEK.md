...
|---|---|---|---|---|---|
| S | Rashee Rice | WR | 8.8 | 11.6 | 2.9 |
| S | Caleb Williams | QB | 18.9 | 21.0 | 2.1 |
|   | Rome Odunze | WR | 8.0 | 8.8 | 0.8 |
| S | Harrison Mevis | K | — | — | — |
| S | Quinshon Judkins | RB | 7.7 | 10.5 | 2.7 |
|   | Emmett Johnson | RB | 2.3 | 1.1 | -1.2 |
|   | Davante Adams | WR | 9.8 | 10.4 | 0.7 |
| S | Derrick Henry | RB | 13.4 | 14.8 | 1.3 |
|   | Courtland Sutton | WR | 7.9 | 8.2 | 0.3 |
| S | Juwan Johnson | TE | 6.7 | 8.2 | 1.5 |
| S | Ja'Marr Chase | WR | 16.3 | 16.8 | 0.5 |
|   | Rachaad White | RB | 5.6 | 7.0 | 1.4 |
| S | Kenneth Walker | RB | 11.2 | 13.7 | 2.5 |
|   | Parker Washington | WR | 7.0 | 9.8 | 2.8 |
|   | Zach Charbonnet | RB | 1.5 | — | — |
| S | HOU D/ST | DEF | — | — | — |

**Lineup swaps:** props starts **Quinshon Judkins** where the champion starts Davante Adams.

**Matchup vs Richard2121:** by the champion 85.1 – 83.9 (gap 1.2); by the props blend 96.6 – 94.9 (gap 1.7). each side's best lineup under that opinion; K/DEF unpriced by both, so the gap is skill slots only
