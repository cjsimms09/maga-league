...
**📅 HARD-DATED BUILD — in-season instrumentation (exp 37, Cory 2026-08-08).** The only item in the 37 complex that cannot be recovered late. **TWO dates, because the roster-move clock starts at the draft, not at kickoff:** (1) **waiver / trade / roster-move logging LIVE BY 2026-08-22 — DRAFT NIGHT.** The first post-draft claim is the first unrecoverable event, and ~3 weeks of claims happen before week 1; a week-1 deadline would silently lose all of them. (2) **lineup start/sit + doctrine logging LIVE BY 2026-09-10 (week-1 kickoff), target 2026-09-08.** Build is `PredLedger` extended to in-season kinds — the same decision-time-capture rail the draft ledger already runs, so this is an extension, not a new system. Sits after the mock-blocker lane and before September; **it is not gated on the 2026 season the way experiment 37 itself is.**
